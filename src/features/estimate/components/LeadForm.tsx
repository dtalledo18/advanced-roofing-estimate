...
export const LeadForm = ({ quote, onSuccess, onBack }: LeadFormProps) => {
    ...
    const rawFinMonthly =
        (quote.total * finR * Math.pow(1 + finR, finN)) / (Math.pow(1 + finR, finN) - 1);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-5 sm:p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-5">
                    <div>
                        ...
                        >
                            <span className="transition-transform group-hover:-translate-x-1">←</span> Back to
                            estimate
                        </button>
                ...
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 flex flex-col justify-between shadow-sm relative overflow-hidden">
                        ...
                        <div className="space-y-2.5 text-sm mb-6">
                            ...
                            {quote.sectionsCount ? (
                                <div className="flex justify-between text-gray-500">
                                    ...
                                    <span className="font-bold text-gray-900">{quote.sectionsCount} sections</span>
                                </div>
                            ) : null}

                            {/* Si es monocapa/modo simple antiguo */}
                            {quote.material && (
                                <div className="flex justify-between text-gray-500">
                                    <span className="font-medium">Material:</span>
                                    <span className="font-bold text-gray-900">
                    {MATERIAL_LABELS[quote.material] ?? quote.material}
                  </span>
                                </div>
                            )}
                    ...
                    {PITCH_LABELS[quote.pitch] ?? quote.pitch.replace("_", " ")}
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                style={{
                                                    ...
                                                    height: "4px",
                                                    borderRadius: "2px",
                                                    background: `linear-gradient(to right, #00589e ${
                                                        ((finApr - 5) / 35) * 100
                                                    }%, #d1d5db ${((finApr - 5) / 35) * 100}%)`,
                                                    outline: "none",
                                                    appearance: "none",
                                                    cursor: "pointer",
                                                }}
                      ...
                      <span className="text-[10px] text-gray-500 uppercase tracking-wider font-bold">
                        ...
                        $
                                                {finMonthly.toLocaleString("en-US", {
